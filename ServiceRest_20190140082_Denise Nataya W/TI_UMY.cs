...
namespace ServiceRest_20190140082_Denise_Nataya_W
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=DESKTOP-JF6PA4C; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=123d"); // Authentication=Windows Authentication
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data source=DESKTOP-JF6PA4C; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=123d"); // Authentication=Windows Authentication
